...
CONFIG = {
    ...
    'servo.pwm_min' : '0.006',
    'servo.max_voltage' : '46.0',
    'servo.flux_brake_min_voltage' : '43.5',
    'servo.flux_brake_resistance_ohm' : '0.1',
    'servo.pid_position.kp' : [
        ('1,2,4,5,7,8,10,11', '400'),
        ('3,6,9,12', '700'),
    ],
    'servo.pid_position.ki' : '0',
    'servo.pid_position.kd' : [
        ('1,2,4,5,7,8,10,11', '10'),
        ('3,6,9,12', '10'),
    ],
    'servo.pid_dq.kp' : '0.1123',
    'servo.pid_dq.ki' : '222.0522',
    'servo.pid_dq.kd' : '0',
    'motor.unwrapped_position_scale' : [
        ('1,2,4,5,7,8,10,11', '0.130378'),
        ('3,6,9,12', '0.093127'),
    ],
